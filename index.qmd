...
```
The three ingredients that show up in nine recipes are nuts, dark chocolate chip and white chocolate chip. I am so sorry that I set  slice_head(n = 20), I only saw one result before. 
```{python}
import pandas as pd
